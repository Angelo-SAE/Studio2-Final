...
[CreateAssetMenu(fileName = "expMotionCurve", menuName = "expMotionCurve")]
public class expMotionCurve : ScriptableObject
{
    ...
    private void OnValidate()
    {
        // Refresh Motion Curve
        {
            ...
            // Deceleration
            float decelStartTime = acceleration.GetDuration() + 0.25f;
...
{
    [SerializeField] expMotionCurve curve;
    ...
    public void Update(bool isMoving)
    {
        ...
        speedPercent = currentCurve.Evaluate(2 * time);
